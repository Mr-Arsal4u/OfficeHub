                ...
                <div class="card">
                    <div class="card-header d-inline-flex mt-50">
                        ...
                        <button class="dt-button add-new btn btn-primary" tabindex="0"
                            ...
                            data-bs-target="#modals-slide-in"><span>Add New Employee</span></button>
                    </div>
                    <div class="card-body ">
                    </div>
...
<div class="modal modal-slide-in new-user-modal fade" id="modals-slide-in" data-bs-backdrop="static"
    ...
    <div class="modal-dialog">
        <form action="{{ route('employees.store') }}" method="POST" class="add-new-employee modal-content pt-0"
