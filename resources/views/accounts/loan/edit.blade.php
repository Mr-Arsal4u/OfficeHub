            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Edit Payment Request</h2>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="badge bg-info">{{ $loan->type->label() }}</span>
                                {!! $loan->status_badge !!}
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="{{ route('request.payment.update', $loan->id) }}" method="POST"
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="submit-btn">
                                        <i data-feather="save" class="me-1"></i> Update Request
                                    </button>
                                </div>
                            </form>
                        </div>
